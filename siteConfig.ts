export const siteConfig = {
  ...
  sections: {
    ...
    company: {
      ...
      quote:
        '우리는 드론 기술을 통해 산업의 문제를 해결하고, 고객의 미래를 함께 만들어가는 혁신 파트너입니다.',
    },
    history: {
      title: '주요 연혁',
    ...
    vision: {
      ...
      vision: {
        ...
        features: [
          ...
          {
            title: '지역 상생',
            description: '도서·산간 응급 물류 및 재난 대응에 같은 플랫폼을 재활용 지속·가능',
          },
        ],
      },
      mission: {
        ...
        features: [
          {
            title: '국방 기술을 통해 군사적 임무와 시민의 안전을 모두 지원하는 이중적 사명을 수행하고 있습니다.',
          },
        ],
      },
    },
